...
const NewAgentEditor = ({ handleClick }) => {  
    ...
    const showFile = async (e) => {
        ...
        reader.onload = async (e) => { 
          ...
          axios.post(`${process.env.VITE_SERVER_CONNECTION_URL}/create_agent_sql`, body).then(res => {
              if (res.data === 'ok') {
                  handleClick();
              } else {
                  console.log(error);
    ...
    const update = async() => {
        ...
        axios.post(`${process.env.VITE_SERVER_CONNECTION_URL}/create_agent`, body).then(res => {
            if (res.data === 'ok') {
                handleClick();
            } else {
